...
PMIX_MCA_psec=native srun -ul --environment ${FCW_CONTAINER_TOML:-./env/ngc-brainbert-25.12-alps2.toml} --mpi pmix --network=disable_rdzv_get --ntasks-per-node=4 all_reduce_perf -b 8 -e 8G -f 2 -g 1 -c 1 -n 20 -w 5